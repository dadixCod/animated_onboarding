...
import 'package:animatedonboarding/view/home_page.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class GetStartBtn extends StatefulWidget {
  const GetStartBtn({super.key, required this.size, required this.textTheme});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: InkWell(
        ...
        onTap: onTap,
        splashColor: MyColors.btnBorderColor.withOpacity(0.5),
        child: Center(
